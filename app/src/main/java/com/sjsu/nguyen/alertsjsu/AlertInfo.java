...
public class AlertInfo extends AppCompatActivity implements View.OnClickListener{
    ...
    private void comment(){
        commentIntent = new Intent(AlertInfo.this, CommentActivity.class);
        commentIntent.putExtra("alertUid", alertUid);
        AlertInfo.this.startActivity(commentIntent);
    }
